...
import {TreeNode} from '../guards/tree/treenode';
import {SharedModule} from '../guards/tree/shared';
import {PrimeTemplate} from '../guards/tree/shared';
import {TreeDragDropService} from '../guards/tree/treedragdropservice';
import {Subscription}   from 'rxjs/Subscription';
import {BlockableUI} from '../guards/tree/blockableui';
        ...
        <ng-template [ngIf]="node">
            ...
            <li *ngIf="!tree.horizontal" [ngClass]="['ui-treenode',node.styleClass||'', isLeaf() ? 'ui-treenode-leaf': '']">
                <div class="ui-treenode-content" (click)="onNodeClick($event)" (contextmenu)="onNodeRightClick($event)" (touchend)="onNodeTouchEnd()"
                    ...
                    <span class="ui-tree-toggler  fa fa-fw" [ngClass]="{'fa-caret-left':!node.expanded,'fa-caret-down':node.expanded}"
