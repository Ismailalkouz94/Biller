...
import {DomHandler} from '../guards/tree/domhandler';
import {Header,Footer,SharedModule} from '../guards/tree/shared';
import {ButtonModule} from '../button/button';
import {Confirmation} from '../guards/tree/confirmation';
import {ConfirmationService} from '../guards/tree/confirmationservice';
...
export class ConfirmDialog implements AfterViewInit,AfterViewChecked,OnDestroy {
    ...
    @Input() acceptLabel: string = 'نعم';
    
    @Input() acceptVisible: boolean = true;

    @Input() rejectIcon: string = 'fa-close';
    
    @Input() rejectLabel: string = 'لا';
