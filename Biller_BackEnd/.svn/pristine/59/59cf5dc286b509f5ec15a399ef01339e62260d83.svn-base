...
public class GlobalTypeServiceImpl implements GlobalTypeService {
    ...
    @Override
    public void deleteGlobalType(String globalTypeId) {
        GlobalType globalType = globalTypeDAO.findGlobalTypeById(globalTypeId);
        if (globalType == null) {
            throw new NotFoundException("Global Type Information Not Exist");
        }
        globalTypeDAO.deleteGlobalType(globalType);
    }
