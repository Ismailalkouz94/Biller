...
public class PersonController {
    ...
    public @ResponseBody
    String update(@RequestParam(value = "personId") Long personId,
    ...
    public @ResponseBody
    String delete(@RequestParam(value = "personId") Long personId) {
    ...
    @ResponseBody
    public Person findById(@RequestParam(value = "personId") Long personId) {
